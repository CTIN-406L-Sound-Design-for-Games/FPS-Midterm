...
public class Controller : MonoBehaviour
{
    ...
    [SerializeField]private SingleSoundSO jumpSO;
    [SerializeField]private SingleSoundSO landSO;
    ...
    void Start()
    {
        JumpingAudioCLip = jumpSO.myAudioClip;
        LandingAudioClip = landSO.myAudioClip;
    ...
    void Update()
    {
        ...
        if (!m_IsPaused && !LockControl)
        {
            ...
            if (m_Grounded && Input.GetButtonDown("Jump"))
            {
                ...
                m_Grounded = false;
                loosedGrounding = true;
                FootstepPlayer.PlayClip(JumpingAudioCLip,jumpSO);
            }
        ...
        {
            FootstepPlayer.PlayClip(LandingAudioClip,landSO);
        }
    }
